...
const RecipesList = (props) => {
  ...
  const getRecipesPetition = async () => {
    const response = await getData("http://98.84.207.18:8080/ListOChef/recipes/userRecipes", token);
    return response;
  };
    ...
    <ImageBackground source={require("../../../assets/fondoApp.png")} style={styles.background} resizeMode="cover">
      <View style={styles.overlay}>
        <View style={styles.container}>
          ...
          <Seeker placeholderText="Search recipe..." onPress={goSearchRecipe}></Seeker>
